...
namespace HC.Stories.Persistence.Context.Migrations
{
    ...
    [Migration("20250516144057_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HC.Stories.Domain.Genres.Genre", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HC.Stories.Domain.Stories.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HC.Stories.Domain.Stories.Story", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HC.Stories.Domain.Stories.StoryAudio", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HC.Stories.Domain.Stories.StoryPage", b =>
                {
                    b.Property<Guid>("StoryId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HC.Stories.Domain.Stories.StoryRating", b =>
                {
                    b.Property<Guid>("StoryId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GenreStory", b =>
                {
                    b.HasOne("HC.Stories.Domain.Genres.Genre", null)
                        .WithMany()
                        .HasForeignKey("GenresId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HC.Stories.Domain.Stories.Story", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HC.Stories.Domain.Stories.Comment", b =>
                {
                    b.HasOne("HC.Stories.Domain.Stories.Story", "Story")
                        .WithMany("Comments")
                        .HasForeignKey("StoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
