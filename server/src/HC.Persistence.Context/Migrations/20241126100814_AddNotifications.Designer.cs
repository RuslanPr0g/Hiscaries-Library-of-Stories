...
namespace HC.Persistence.Context.Migrations
{
    ...
    [Migration("20241126100814_AddNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HC.Domain.Notifications.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HC.Domain.Notifications.UserAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HC.Domain.PlatformUsers.PlatformUserToLibrarySubscription", b =>
                {
                    ...
                    b.ToTable("PlatformUserToLibrarySubscriptions");
                });
            ...
            modelBuilder.Entity("HC.Domain.Notifications.UserAccount", b =>
                {
                    b.HasOne("HC.Domain.Notifications.RefreshToken", "RefreshToken")
                        .WithOne()
                        .HasForeignKey("HC.Domain.Notifications.UserAccount", "RefreshTokenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
